  ...
  head: () => ({
    meta: [
      ...
      { title: "Workly AI — AI Workplace Productivity Assistant" },
      {
        name: "description",
        content:
          "Workly AI helps you draft emails, summarize meetings, plan tasks, research topics and chat with an AI workplace assistant.",
      },
      ...
      { property: "og:title", content: "Workly AI — AI Workplace Productivity Assistant" },
      {
        ...
        content:
          "Five AI productivity tools in one dashboard: emails, meeting summaries, task plans, research briefs and workplace chat.",
      },
